...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var eventemitter3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! eventemitter3 */ \"./node_modules/eventemitter3/index.js\");\n/* harmony import */ var eventemitter3__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(eventemitter3__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _utils_PacketDataPlayer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/PacketDataPlayer */ \"./src/utils/PacketDataPlayer.ts\");\n\n\nconst worker = self;\nconst events = new eventemitter3__WEBPACK_IMPORTED_MODULE_0___default.a();\nworker.addEventListener('message', function (ev) {\n    const [type, ...args] = ev.data;\n    events.emit(type, ...args);\n});\nlet player;\nevents.on('load', function (replay) {\n    if (player) {\n        player.pause();\n    }\n    player = new _utils_PacketDataPlayer__WEBPACK_IMPORTED_MODULE_1__[\"default\"](replay, function (ts, type, data) {\n        emit('packet', ts, type, data);\n    }, function (to) {\n        emit('seek', to);\n    }, function () {\n        emit('end');\n    });\n});\nevents.on('play', function () {\n    if (player) {\n        player.play();\n    }\n});\nevents.on('pause', function () {\n    if (player) {\n        player.pause();\n    }\n});\nevents.on('seek', function (to) {\n    if (player) {\n        player.seek(to);\n    }\n});\nfunction emit(type, ...args) {\n    worker.postMessage([type, ...args]);\n}\n\n\n//# sourceURL=webpack:///./src/worker.ts?");
